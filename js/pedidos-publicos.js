...
addEventListener("DOMContentLoaded",async()=>{
  ...
  function renderizar(pedidos){
    ...
    lista.innerHTML=pedidos.length?pedidos.map((p,i)=>{
      ...
      const atalhos=convertido?`${idUtente?`<a class="botao botao-principal" href="gestao-aconselha.html?idUtente=${encodeURIComponent(idUtente)}">Abrir Utente</a>`:""}${idTriagem?`<a class="botao botao-principal" href="triagens-pendentes.html?idTriagem=${encodeURIComponent(idTriagem)}&estado=Todos">Abrir Triagem</a>`:""}`:"";
